...
const summary = () => {
  ...
  const [adress,setAdd]=useState(add)
  // setAdd((add)=>add)
  console.log(adress)
  return (
        ...
        <Card w={"600px"} marginLeft={"150px"}>
          <CardBody>
            ...
            <Text fontSize={"11px"} color={"gray.400"}>
              Save an additional 5% on prescription medicine & earn 3% NeuCoins
              on other health products. Get same day, next day with Rapid and
            ...
            >
              <div>
                <img
                  width={"40px"}
                  height={"40px"}
                  src="https://onemg.gumlet.io/a_ignore,w_380,h_380,c_fit,q_auto,f_auto/oiiqclterzwnvkkeeq0z.jpg"
                  alt=""
                />
              </div>
              <div>
                <Text fontSize={"12px"}>Accu-Chek Guide Wireless Bloo...</Text>
                <Text fontSize={"11px"} color={"gray.400"}>
                  box of 1 Unit
                </Text>
              </div>
