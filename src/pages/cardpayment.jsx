        ...
        return (
          ...
          {emp()}
            ...
            disabled={false}
              ...
              bg=""
              isDisabled={cardnum==""||month==""||year==""||cvv==""||name==""}
            >
              Proceed to payment
            </Button>
            ...
            <Modal isCentered isOpen={isOpen} onClose={onClose}>
              ...
              <ModalContent>
                ...
                <ModalCloseButton />
                <ModalBody>
               <div style={{border:"1px solid", height:"40px",width:"150px",padding:"6px",backgroundColor:"grey",fontSize:"15px",fontWeight:"bold",margin:"20px"}}>
                        <Text textAlign={"center"}>Captcha:{captcha}</Text>
               </div>
                  <Input type={"text"} placeholder={"enter captcha"} onChange={(e)=>setCheck(e.target.value)} value={check}/>
                </ModalBody>
                <ModalFooter>
                  <Button
    ...
    return (
      <div style={{ gap: "40px",backgroundColor:"white" }}>
        <div style={{ marginTop: "0px" }}>
          <p style={{ fontSize: "14px", fontWeight: "bold" }}>Credit & bills</p>
        ...
        <div style={{ display: "flex", marginLeft: "70px",marginTop:"20px", gap: "10px" }}>
          <img
    ...
    >
      ...
      <div style={{ width: "30%", border: "0px solid red", height: "auto" }}>
        ...
        <div  style={{
            ...
            <img src="https://onemg.gumlet.io/marketing/01e510d5-905f-4aab-be4d-8470cb7389ce.jpg" alt="" />
            <Text fontSize={"12px"}>Pay with Paytm and get up to ₹400 cashback. T&C apply.</Text>
        </div>
        <div
          style={{
            height: "auto",
