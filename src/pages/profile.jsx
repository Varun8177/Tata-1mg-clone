    ...
    >
      ...
      >
        ...
        >
          <div style={{ margin:"20px"}}>
            <div style={{ marginTop: "10px",fontSize:"16px",fontWeight:"bold"}}>
              <h5 style={{ color: swth2 ? "red" : "black",}}>Subscribe to marketing emails</h5>
            </div>
            <div style={{ marginTop: "20px" }}>
              <p>
        ...
        >
           <div style={{ margin:"20px"}}>
            <div style={{ marginTop: "10px",fontSize:"16px",fontWeight:"bold"}}>
              <h5 style={{ color: swth ? "red" : "black",}}>Get whatsapp notifications</h5>
            </div>
            <div style={{ marginTop: "20px" }}>
              <p>
              We will send you the latest notifications related to your orders and lab reports to your mobile number
              </p>
            </div>
          </div>
          <div style={{ marginTop: "20px" }}>
