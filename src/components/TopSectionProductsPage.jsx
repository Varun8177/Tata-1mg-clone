...
const TopSectionProductsPage = () => {
    ...
    return (
        <>
            <Box mt='10px'>
                <Text>
                    <span onClick={() => router.push('/')} style={{ color: '#ff6f61', cursor: 'pointer', fontSize: '12px' }}>Home</span>
                    <span style={{ color: 'grey', fontSize: '12px' }}>{' > '}All Products</span>
                </Text>
                <Heading
                    ...
                    m='10px 0'
                >
                    TATA 1MG HEALTH PRODUCTS</Heading>
            </Box>
            <Image
